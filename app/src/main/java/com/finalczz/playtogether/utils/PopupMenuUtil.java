...
import com.finalczz.playtogether.controller.activity.PublicArticleActivity;
...
public class PopupMenuUtil {
    ...
    private void createView(final Context context) {
        rootVew = LayoutInflater.from(context).inflate(R.layout.popupwindow, null);
    ...
    private void initLayout(Context context) {
        ...
        ivBtn = (ImageView) rootVew.findViewById(R.id.pop_center_add);
        ...
        llTest1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(currentActivity,PublicArticleActivity.class);
